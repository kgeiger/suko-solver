...
void writeout(int a[], int width)
{
	...
	/*
	 * End the _GRID_INIT macro def with the proper closing
	 * brace style after writing all permutations.
	 */
	if (++permutation_knt < PERMUTATIONS_MAX)
		end_of_line= "},\\\n";	/* end of one permutation */
	else
		end_of_line= "}}\n\n";  /* end of permutation list */
